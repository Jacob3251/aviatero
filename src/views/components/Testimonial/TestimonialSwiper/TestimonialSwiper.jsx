            ...
            <div className="w-[75%]  max-h-full sm:max-h-full  h-full mx-auto   overflow-hidden flex justify-center items-center ">
              <div className="flex flex-col md:flex-row testimonial-item w-full space-y-5 xl:space-y-0 md:space-x-[40px]  justify-center items-center px-[80px] ">
                ...
                <div className="w-full max-w-[600px] h-full  flex flex-col justify-center items-start">
                  <div className="text-[18px] sm:text-[24px] xl:text-[32px] font-noto text-primary font-medium mb-2 xl:mb-[20px]">
                    Nazia Islam
                  </div>
                  <div className="text-[14px] sm:text-[18px] xl:text-[18px] font-noto text-secondary font-medium mb-2 xl:mb-[20px]">
                    <GoLocation /> <span>Sylhet, Bangladesh </span>
                  </div>
                  <div className="text-primary text-[16px] sm:text-[20px] space-x-[5px] xl:space-x-[8px] mb-2 xl:mb-[20px]">
                    <FaStar />
                    <FaStar />
                    <FaStar />
                    <FaStar />
                  ...
                  <div className="flex justify-start mb-2 xl:mb-[45px]">
